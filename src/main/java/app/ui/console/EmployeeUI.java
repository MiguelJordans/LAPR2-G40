        ...
        do {
            do {
                ...
                try {
                    ...
                    if (orgRole.equals("SPECIALIST_DOCTOR") || orgRole.equals("RECEPTIONIST") || orgRole.equals("MEDICAL_LAB_TECHNICIAN") || orgRole.equals("CLINICAL_CHEMISTRY_TECHNOLOGIST")||orgRole.equals("LABORATORY_COORDINATOR")) {
                        m=false;
                    }
                    else {
                    ...
                    if (orgRole.equals("SPECIALIST_DOCTOR")) {
